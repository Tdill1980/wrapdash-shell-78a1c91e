    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Showcase your best wrap designs and projects
        </p>
      </div>
      ...
      <Card className="p-12 bg-card border-border rounded-2xl text-center">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-muted-foreground">
            Create stunning portfolio galleries to showcase your work, attract
            new clients, and share your wrap design expertise.
          </p>
        </div>
      </Card>
    </div>

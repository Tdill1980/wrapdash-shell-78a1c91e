...
interface TruckImageOverlayProps {
...
export function TruckImageOverlay({
  selectedPanels,
  onPanelClick,
  sqftOptions,
  hoveredPanel,
  onPanelHover
}: TruckImageOverlayProps) {
  ...
  return (
    <div className="relative w-full">
      ...
      >
        {/* Hood zone - front of truck */}
        <polygon
          points="120,280 120,200 280,180 280,280"
        ...
        {/* Roof zone - cab roof */}
        <polygon
          points="280,180 280,120 520,120 520,180"
        ...
        {/* Sides zone - cab and bed sides */}
        <polygon
          points="280,180 280,320 900,320 900,180 520,180 520,120 280,120"
        ...
        {/* Back zone - tailgate */}
        <polygon
          points="880,180 880,320 920,320 920,180"
      ...
      {sqftOptions && (
        <div className="absolute inset-0 pointer-events-none">
          {/* Hood label */}
          <div className="absolute left-[15%] top-[45%] transform -translate-x-1/2 -translate-y-1/2">
          ...
          {/* Sides label */}
          <div className="absolute left-[55%] top-[50%] transform -translate-x-1/2 -translate-y-1/2">
            <span className={`text-xs font-bold px-2 py-1 rounded ${
          ...
          {/* Back label */}
          <div className="absolute right-[8%] top-[50%] transform -translate-x-1/2 -translate-y-1/2">
            <span className={`text-xs font-bold px-2 py-1 rounded ${

...
interface SedanImageOverlayProps {
...
export function SedanImageOverlay({
  selectedPanels,
  onPanelClick,
  sqftOptions,
  hoveredPanel,
  onPanelHover
}: SedanImageOverlayProps) {
  ...
  return (
    <div className="relative w-full">
      {/* Base vehicle image */}
      <img 
        src="/vehicles/sedan-side.png" 
        alt="Sedan side profile"
      ...
      >
        {/* Hood zone - front of sedan */}
        <polygon
          points="100,280 100,200 300,160 300,280"
        ...
        {/* Roof zone - sedan roof */}
        <polygon
          points="300,160 300,100 700,100 700,160"
        ...
        {/* Sides zone - doors and quarter panels */}
        <polygon
          points="300,160 300,320 700,320 700,160"
        ...
        {/* Back zone - trunk */}
        <polygon
          points="700,160 700,280 900,240 900,160"
      ...
      {sqftOptions && (
        <div className="absolute inset-0 pointer-events-none">
          {/* Hood label */}
          <div className="absolute left-[18%] top-[45%] transform -translate-x-1/2 -translate-y-1/2">
          ...
          {/* Roof label */}
          <div className="absolute left-[50%] top-[22%] transform -translate-x-1/2 -translate-y-1/2">
            <span className={`text-xs font-bold px-2 py-1 rounded ${
          ...
          {/* Back label */}
          <div className="absolute right-[15%] top-[42%] transform -translate-x-1/2 -translate-y-1/2">
            <span className={`text-xs font-bold px-2 py-1 rounded ${

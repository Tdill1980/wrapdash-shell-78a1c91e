...
interface SUVImageOverlayProps {
...
export function SUVImageOverlay({
  selectedPanels,
  onPanelClick,
  sqftOptions,
  hoveredPanel,
  onPanelHover
}: SUVImageOverlayProps) {
  ...
  return (
    <div className="relative w-full">
      {/* Base vehicle image */}
      <img 
        src="/vehicles/suv-side.png" 
        alt="SUV side profile"
      ...
      >
        {/* Hood zone - front of SUV */}
        <polygon
          points="100,300 100,180 280,150 280,300"
        ...
        {/* Roof zone - SUV roof */}
        <polygon
          points="280,150 280,90 750,90 750,150"
        ...
        <polygon
          points="280,150 280,340 750,340 750,150"
        ...
        {/* Back zone - rear hatch */}
        <polygon
          points="750,90 750,340 920,300 920,130"
      ...
      {sqftOptions && (
        <div className="absolute inset-0 pointer-events-none">
          {/* Hood label */}
          <div className="absolute left-[16%] top-[48%] transform -translate-x-1/2 -translate-y-1/2">
          ...
          {/* Roof label */}
          <div className="absolute left-[50%] top-[20%] transform -translate-x-1/2 -translate-y-1/2">
            <span className={`text-xs font-bold px-2 py-1 rounded ${
          ...
          {/* Back label */}
          <div className="absolute right-[12%] top-[45%] transform -translate-x-1/2 -translate-y-1/2">
            <span className={`text-xs font-bold px-2 py-1 rounded ${

  ...
  return (
    <MainLayout>
      <div className="w-full min-h-screen flex gap-6">
        {/* LEFT SIDEBAR */}
        <div className="w-[320px] bg-card p-6 flex flex-col gap-6 border border-border rounded-xl">
          <h1 className="text-2xl font-bold">
            <span className="text-primary">DesignPanelPro</span>
          ...
          <button 
            ...
            disabled={loading}
            className="mt-4 bg-primary text-primary-foreground py-3 rounded-xl text-lg font-bold hover:bg-primary/90 disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="bg-card border border-border p-6 rounded-xl">
            ...
            <div className="bg-background rounded-xl h-[450px] flex items-center justify-center border border-border">
              {preview ? (
                <img src={preview} className="max-w-full max-h-full rounded-lg" alt="Panel preview" />
              ) : (
          ...
          <div className="bg-card border border-border p-6 rounded-xl">
            ...
            <div className="bg-background rounded-xl h-[400px] flex items-center justify-center border border-border">
              {threeD ? (
                <img src={threeD} className="max-w-full max-h-full rounded-lg" alt="3D render" />
              ) : (
            ...
            <div className="bg-background rounded-xl p-6 border border-border">
              {printURL ? (
                <a 
                  href={printURL}
                  download
                  className="bg-primary text-primary-foreground px-6 py-3 rounded-lg inline-flex items-center gap-2 hover:bg-primary/90 font-medium"
                >
                  Download Print-Ready TIFF (300 DPI)
                </a>
              ) : (
                <span className="text-muted-foreground">Print file will be available after generation</span>
              )}
            </div>
          </div>

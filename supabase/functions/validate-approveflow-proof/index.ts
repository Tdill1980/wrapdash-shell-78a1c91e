...
// Required view keys - exactly these 6, no substitutions
const REQUIRED_VIEWS = ['driver', 'passenger', 'front', 'rear', 'top', 'detail'] as const;
...
serve(async (req) => {
  ...
  try {
    ...
    // ============================================
    // REQUIRED VIEWS CHECK (All 6 must exist)
    // ============================================
    ...
    console.log(`[validate-approveflow-proof] Validation result: ok=${ok}, missing=${missing.join(', ')}`);

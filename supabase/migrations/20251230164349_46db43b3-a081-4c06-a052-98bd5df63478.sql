-- Create view that correctly identifies conversations needing response
-- (last inbound message > last outbound message)
CREATE OR REPLACE VIEW ops_backlog_needs_response AS
